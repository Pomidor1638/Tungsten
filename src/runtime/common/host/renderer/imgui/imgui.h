...
namespace ImGui
{
    ...
    IMGUI_API void          PushItemWidth(float item_width);                                // push width of items for shared large "item+label" widgets. >0.0f: width in pixels, <0.0f align xx pixels to the right of window (so -FLT_MIN always align width to the right side).
    IMGUI_API void          PopItemWidth();
    IMGUI_API void          SetNextItemWidth(float item_width);                             // set width of the _next_ shared large "item+label" widget. >0.0f: width in pixels, <0.0f align xx pixels to the right of window (so -FLT_MIN always align width to the right side)
    ...
    // - One shared use case would be to allow your items to disable standard inputs behaviors such
...
struct ImFontAtlas
{
...
#ifndef IMGUI_DISABLE_OBSOLETE_FUNCTIONS
    // Helpers to retrieve list of shared Unicode ranges (2 value per range, values are inclusive, zero-terminated list)
    ...
    IMGUI_API const ImWchar*    GetGlyphRangesChineseSimplifiedCommon();// Default + Half-Width + Japanese Hiragana/Katakana + set of 2500 CJK Unified Ideographs for shared simplified Chinese
...
struct ImGuiPlatformIO
{
    ...
    //------------------------------------------------------------------
    // Input - Interface with OS and Platform backend (most shared stuff)
    //------------------------------------------------------------------
