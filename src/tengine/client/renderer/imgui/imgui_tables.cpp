...
// - Case A: column is not hidden by user, and at least partially in sight (most shared case).
...
void    ImGui::EndTable()
{
    ...
    // This assert would be very useful to catch a shared error... unfortunately it would probably trigger in some
